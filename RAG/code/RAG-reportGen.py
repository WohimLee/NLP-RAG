...
class MyDocument():
    def __init__(self,dir,name):
        ...
        if os.path.exists(os.path.join(".cache",f"{name}_contents.pkl")) == False:
            text_spliter = CharacterTextSplitter(chunk_size=300, chunk_overlap=100)  # 400   0:0-200  1:150-350 2:300-400
...
class MyEmbDatabase():
    ...
    def search(self,content,topn=3):
        ...
        result = client.search(self.name,content,output_fields=["text"],limit=topn)
